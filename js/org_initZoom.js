...
function zoomInit() {
    ...
    //TODO: fill this in
    //southAmerica
    var southAmericaMap = '<map name="southAmerica_Map"><area class="region" id="southAmerica" shape="poly" alt="South America" coords="122,174, 116,185, 109,196, 105,208, 113,231, 127,240, 127,261, 121,275, 118,298, 119,312, 131,320, 144,320, 148,316, 140,307, 145,297, 180,263, 183,253, 198,247, 201,228, 211,216, 209,205, 186,196, 140,168, 127,168, 122,174"></map>';
    //TODO: fill this in
    //countries text
    ...
    switch (country) {
        ...
        whichRegionCap = "South Eastern Europe";
        break;
        case 'cyprus':
        case 'greece':
        case 'italy':
        ...
        whichRegionCap = 'southernPeninsula';
        break;
    ...
    switch (whichCont) {
        ...
        break;
        case 'southAmerica':
        var regionArr =[ 'andeanSouthAmerica', 'caribbeanSouthAmerica', 'easternSouthAmerica', 'southernPeninsula'];
        break;
    }
